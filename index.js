...
class SwipeAbleDrawer extends Component {
  ...
  constructor(props) {
    ...
    this.isBlockDrawer = props.isBlockDrawer || false;
    this.translateX = 0;
    this.scale = 1;
    this.drawerAnimation = new Animated.Value(0);
    this.positionDrawer = props.position || "left";
    this.positionDrawer;
    this.maxTranslateXValue =
      this.positionDrawer === "left"
...
SwipeAbleDrawer.propTypes = {
  ...
  scalingFactor: React.PropTypes.number,
  minimizeFactor: React.PropTypes.number,
